        ...
        <div className="w-full font-sans text-left mx-auto max-w-2xl">
            ...
            <div className="flex items-center justify-center gap-3 mb-6 flex-wrap">
                <div className="bg-blue-50 border-2 border-blue-200 rounded-xl px-4 py-3 text-center">
                    <div className="text-2xl font-black text-blue-700">${perPack} 瓶</div>
                    <div className="text-sm text-blue-600">每組瓶數</div>
                </div>
                <div className="text-2xl text-slate-400 font-bold">×</div>
                <div className="bg-blue-50 border-2 border-blue-200 rounded-xl px-4 py-3 text-center">
                    <div className="text-2xl font-black text-blue-700">${groups} 組</div>
                    <div className="text-sm text-blue-600">組數</div>
                </div>
                <div className="text-2xl text-slate-400 font-bold">=</div>
                <div className="bg-slate-50 border-2 border-slate-200 rounded-xl px-4 py-3 text-center">
                    <div className="text-2xl font-black text-slate-700">${total} 瓶</div>
                    <div className="text-sm text-slate-500">總瓶數</div>
                </div>
                <div className="text-2xl text-slate-400 font-bold">÷</div>
                <div className="bg-amber-50 border-2 border-amber-200 rounded-xl px-4 py-3 text-center">
                    <div className="text-2xl font-black text-amber-700">${gift} 瓶</div>
                    <div className="text-sm text-amber-600">每人贈瓶數</div>
                </div>
                <div className="text-2xl text-slate-400 font-bold">=</div>
                <div className="bg-green-50 border-2 border-green-200 rounded-xl px-4 py-3 text-center min-w-[64px]">
                    ...
                    <div className="text-sm text-green-600">個顧客</div>
                </div>
            </div>
